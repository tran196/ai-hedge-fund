...
def get_model_tier_info() -> Dict[str, Dict]:
    ...
    """
    return {
        ClaudeModelTier.OPUS.value: {"model": CLAUDE_MODELS[ClaudeModelTier.OPUS], "description": "Most capable - deep reasoning and analysis", "use_cases": ["Famous investor agents", "Complex valuation", "Strategic decisions"], "cost": "High"},
        ClaudeModelTier.SONNET.value: {"model": CLAUDE_MODELS[ClaudeModelTier.SONNET], "description": "Balanced - good reasoning at lower cost", "use_cases": ["Technical analysis", "Sentiment analysis", "Risk management"], "cost": "Medium"},
        ClaudeModelTier.HAIKU.value: {"model": CLAUDE_MODELS[ClaudeModelTier.HAIKU], "description": "Fast and efficient - quick decisions", "use_cases": ["Simple formatting", "Quick summaries", "High-volume tasks"], "cost": "Low"},
    }
